...
class AnalyticsEngine:
    ...
    def create_applications_over_time_chart(self, df_apps: pd.DataFrame):
        ...
        fig.update_layout(template="plotly_white", xaxis_title="Date", yaxis_title="Applications Sent")
        return fig
    ...
    def create_salary_distribution_chart(self, df_jobs: pd.DataFrame):
        ...
        fig.update_layout(template="plotly_white", xaxis_title="Salary Bracket", yaxis_title="Job Count")
        return fig
    ...
    def predict_valuable_skills(self) -> list[dict]:
        ...
        return [
            ...
            {"skill": "Python / FastAPI", "market_demand": "High (89%)", "salary_tier": "$145,000+", "trend": "Rising Demand"},
            {"skill": "PyTorch / ML Ops", "market_demand": "Very High (92%)", "salary_tier": "$175,000+", "trend": "High Value"},
            {"skill": "Playwright Automation", "market_demand": "Medium (78%)", "salary_tier": "$135,000+", "trend": "Steady"},
            {"skill": "Streamlit / Data Dashboards", "market_demand": "Medium (74%)", "salary_tier": "$130,000+", "trend": "Growing"},
        ]
